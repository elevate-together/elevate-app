...
import {NoDataDisplay, PushNotificationManager} from "@/components/common";
import { NotificationCard } from "@/components/data-handlers";
    ...
    <div className="flex flex-col flex-1 min-h-full bg-card">
      ...
      {notifications.length > 0 ? (
        <div className="space-y-4">
          ...
          <div className="flex flex-1 flex-col items-center space-y-2 pb-4">
